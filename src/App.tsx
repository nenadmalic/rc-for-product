...
export default function App() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="closing" aria-labelledby="closing-title"><div className="wrap closing-layout"><div><span className="overline">GET STARTED</span><h2 id="closing-title">Build the monetization your product needs next</h2><p>Start with your first purchase experience or improve one that’s already live.</p></div><div className="closing-actions"><a className="button button-light" href="https://app.revenuecat.com/signup">Start for free <ActionIcon/></a><a className="button button-outline" href="https://www.revenuecat.com/talk-to-sales">Talk to sales <ActionIcon/></a></div></div></section>
    </main>
